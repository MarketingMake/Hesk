...
/*
*
* Language file for Sistema SAC Software HESK (https://www.hesk.com)
...
*/
//jailson
$hesklang['at_least_one_file'] = 'É obrigatório anexar ao menos um arquivo para abrir o chamado.';
...
// EMAIL SUBJECTS
$hesklang['new_ticket_staff']='[#%%TRACK_ID%%] Nova solicitação: %%SUBJECT%%';
$hesklang['ticket_received']='[#%%TRACK_ID%%] Solicitação recebida: %%SUBJECT%%';
$hesklang['ticket_assigned_to_you']='[#%%TRACK_ID%%] Solicitação atribuída: %%SUBJECT%%';
...
$hesklang['category_moved']='[#%%TRACK_ID%%] Solicitação movida: %%SUBJECT%%';
$hesklang['new_note']='[#%%TRACK_ID%%] Observação adicionada a: %%SUBJECT%%';
$hesklang['new_pm']='Nova mensagem privada: %%SUBJECT%%';
$hesklang['forgot_ticket_id']='Lista de suas solicitações';
...
$hesklang['not_authorized_tickets']='Você não está autorizado a ver solicitações dentro desta categoria!';
...
$hesklang['ticket_not_found']='Solicitação não encontrada! Por favor certifique-se de ter digitado o código de identificação correto!';
$hesklang['no_selected']='Nenhuma solicitação selecionada, nada a alterar';
...
$hesklang['enter_subject']='Por favor digite o assunto da solicitação';
...
$hesklang['cant_del_default_cat']='Você não pode remover a categoria padrão, você pode apenas renomeá-la';
...
$hesklang['enter_ticket_subject']='Por favor digite o assunto da sua solicitação';
...
$hesklang['displaying_pages']='Exibindo <b>%d</b> solicitações. Páginas:';
...
$hesklang['tickets_page']='Solicitações por página';
$hesklang['find_ticket']='Procurar solicitação';
...
$hesklang['ticket']='Solicitação';
$hesklang['tickets']='Solicitações';
$hesklang['ticket_been']='Esta solicitação foi';
$hesklang['view_ticket']='Ver solicitação';
$hesklang['open_tickets']='Abrir solicitações';
...
$hesklang['ticket_marked']='Esta solicitação foi marcada';
$hesklang['ticket_status']='Status da solicitação';
...
$hesklang['close_this_ticket']='Marcar esta solicitação como Resolvida';
...
$hesklang['ticket_trackID']='Código de identificação da solicitação';
$hesklang['c2c']='Clique para continuar';
$hesklang['tickets_deleted']='Solicitações removidas';
$hesklang['num_tickets_deleted']='<b>%d</b> solicitações foram removidas';
...
para categorizar as solicitações por relevância (por exemplo "Vendas",
...
solicitações enviadas para a categoria "Vendas")';
...
responder as solicitações. Administradores podem ver/editar as solicitações em qualquer categoria e tem acesso
a todos os recursos do painel administrativo (gerenciar usuários, gerenciar categorias, ...) enquanto
outros usuários podem apenas ver e responder as solicitações dentro de suas categorias.';
$hesklang['yes']='SIM';
$hesklang['no']='NÃO';
...
$hesklang['notify_new_posts']='Me notifique de novas solicitações e postagens em minhas categorias';
$hesklang['view_profile']='Ver perfil';
$hesklang['new_ticket_submitted']='Nova solicitação enviada';
...
$hesklang['end_ticket']='--- Fim da solicitação ---';

// CUSTOMER INTERFACE
$hesklang['your_ticket_been']='Sua solicitação foi';
$hesklang['view_your_ticket']='Ver sua solicitação';
$hesklang['submit_ticket']='Crie uma nova solicitação';
$hesklang['sub_ticket']='Enviar solicitação';
...
$hesklang['reply_submitted_success']='Sua resposta a esta solicitação foi enviada com sucesso';
$hesklang['ticket_submitted']='Solicitação enviada';
$hesklang['ticket_submitted_success']='Sua solicitação foi enviada com sucesso! Identificação da solicitação';
$hesklang['your_ticket']='Sua solicitação';
...
$hesklang['close_selected']='Marcar as solicitações selecionadas como Resolvidas';
...
$hesklang['saved_rem_full']='A resposta automática selecionada foi removida do banco de dados';
...
$hesklang['tickets_closed']='Solicitações fechadas';
$hesklang['num_tickets_closed']='<b>%d</b> solicitações foram fechadas';
...
$hesklang['move_to_catgory']='Mover solicitação para';
$hesklang['move']='Mover';
$hesklang['moved']='Solicitação movida';
$hesklang['moved_to']='Esta solicitação foi movida para a nova categoria';
$hesklang['url']='URL';
...
$hesklang['err_max']='Por favor digite a quantidade máxima listada por página';
...
$hesklang['tid_not_found']='Nenhuma solicitação com seu endereço de e-mail foi encontrada';
$hesklang['tid_sent']='Código de identificação enviado';
$hesklang['tid_sent2']='Um e-mail com detalhes sobre suas solicitações foi enviado para o seu endereço';
...
$hesklang['sub_support']='Nova solicitação';
$hesklang['open_ticket']='Enviar uma nova solicitação para um departamento';
$hesklang['view_existing']='Ver solicitação existente';
$hesklang['vet']='Ver solicitações que você enviou no passado';
...
$hesklang['tickets_on_pages']='Número de solicitações: %d | Número de páginas: %d'; // First %d is replaced with number of tickets, second %d with number of pages
$hesklang['jump_page']='Ir para a página:';
$hesklang['no_tickets_open']='Nenhuma solicitação não resolvida encontrada';
$hesklang['no_tickets_crit']='Nenhuma solicitação encontrada correspondendo aos seus critérios';
$hesklang['confirm_execute']='Você tem certeza de que deseja continuar?';
...
Uma base de conhecimento abrangente e bem escrita pode diminuir drasticamente o número de solicitações que você recebe e economizar muito seu tempo. Você pode organizar artigos em categorias
...
$hesklang['kb_cat_added2']='Uma nova categoria foi adicionada com sucesso na base de conhecimento';
...
$hesklang['can_view_tickets']='Ver solicitações';
$hesklang['can_reply_tickets']='Responder a solicitações';
$hesklang['can_assign_tickets']='Atribuir solicitações';
$hesklang['can_del_tickets']='Remover solicitações';
$hesklang['can_edit_tickets']='Editar respostas a solicitações';
$hesklang['can_change_cat']='Pode alterar a categoria da solicitação (para qualquer uma)';
...
$hesklang['can_del_notes']='Remover qualquer observação de solicitação';
$hesklang['dan']='usuários podem remover suas próprias observações em solicitações, selecione isto apenas se você desejar permitir a este usuário a também poder remover observações de outros usuários';
...
$hesklang['na_view_tickets']='Você não está autorizado a ver solicitações';
...
$hesklang['cw2']='Fechar janela e enviar solicitação';
...
$hesklang['nosr']='Não foram encontrados artigos correspondentes. Tente navegar na base de conhecimento ou enviar uma nova solicitação.';
...
$hesklang['not']='Solicitações'; // Number of all tickets in category
$hesklang['graph']='Gráfico';
$hesklang['lu']='Listar usuários';
$hesklang['aclose']='Fechar solicitações automaticamente';
$hesklang['aclose2']='dias após a última resposta da equipe';
$hesklang['s_ucrt']='Reabrir solicitações';
...
$hesklang['dele']='Remover esta solicitação';
...
$hesklang['aftrep']='Após responder a uma solicitação';
$hesklang['showtic']='Exibir a solicitação que eu acabei de responder';
$hesklang['gomain']='Retornar a página principal da administração';
$hesklang['shownext']='Abrir a próxima solicitação que precisa de minha resposta';
$hesklang['rssn']='Exibindo a próxima solicitação que precisa de sua atenção';
...
$hesklang['chpri2']='A prioridade da solicitação foi alterada para %s';
...
$hesklang['genl2']='Usar este link para pré-selecionar a categoria no formulário "Enviar uma solicitação".';
...
$hesklang['asst2']='Atribuir esta solicitação a';
$hesklang['asss']='Atribuir a si próprio';
$hesklang['asss2']='Atribuir esta solicitação a si próprio';
$hesklang['can_assign_self']='Pode atribuir solicitações a si próprio';
$hesklang['can_assign_others']='Pode atribuir solicitações a outros';
$hesklang['can_run_reports']='Pode executar relatórios (próprios)';
$hesklang['can_view_ass_others']='Pode ver solicitações atribuídas a outros';
$hesklang['unoa']='O usuário selecionado não possui acesso a esta categoria';
$hesklang['tasi']='Responsável atribuído';
$hesklang['tasy']='Esta solicitação foi atribuída a você';
$hesklang['taso']='Esta solicitação foi atribuída ao usuário selecionado';
$hesklang['tasy2']='Atribuída a mim';
$hesklang['taso2']='Atribuída a outro membro da equipe';
$hesklang['nose']='Selecione o novo responsável';
$hesklang['onasc']='Este responsável não possui acesso a categoria selecionada.';
$hesklang['tunasi']='Solicitação não atribuída';
$hesklang['tunasi2']='A solicitação está sem um responsável e pronta para ser atribuída novamente';
$hesklang['note']='Observação';
$hesklang['success']='Sucesso';
$hesklang['nyt']='Esta solicitação está atribuída a';
...
$hesklang['reports_intro']='A seção de relatórios lhe permite executar vários relatórios e ver estatísticas de solicitações em um período de datas selecionado.';
...
$hesklang['t1']='Solicitações por dia';
$hesklang['t2']='Solicitações por mês';
$hesklang['t3']='Solicitações por usuário';
$hesklang['t4']='Solicitações por categoria';
$hesklang['ticass']='Solicitações atribuídas';
$hesklang['ticall']='Respondeu às solicitações';
$hesklang['totals']='Totais';
$hesklang['all']='Todos';
$hesklang['atik']='Novas solicitações';
...
$hesklang['e_tid']='Erro ao gerar um código de identificação único para a solicitação, por favor tente enviar o formulário novamente mais tarde.';
...
$hesklang['s_my']='Atribuída a mim';
$hesklang['s_ot']='Atribuída a outros';
$hesklang['s_un']='Solicitações não atribuídas';
$hesklang['s_for']='Pesquisar por';
$hesklang['s_in']='Pesquisar em';
$hesklang['s_incl']='Pesquisar dentro';
$hesklang['find_ticket_by']='Encontrar uma solicitação';
$hesklang['e_nose']='Nenhum status de atribuição selecionado, exibindo todas as solicitações.';
$hesklang['fsq']='Digite seu termo de pesquisa';
$hesklang['topen']='Aberto';
$hesklang['nms']='Nenhuma mensagem selecionada, nada a alterar';
$hesklang['tlo']='Bloquear solicitação';
$hesklang['tul']='Desbloquear solicitação';
$hesklang['loc']='Bloqueado';
$hesklang['isloc']='Os clientes não podem responder ou reabrir solicitações bloqueadas. Quando bloqueada a solicitação é marcada como resolvida.';
$hesklang['tlock']='A solicitação foi bloqueada';
$hesklang['tunlock']='A solicitação foi desbloqueada';
$hesklang['tislock']='Esta solicitação foi bloqueada, o cliente não poderá postar uma resposta.';
$hesklang['tislock2']='Esta solicitação foi bloqueada, você não pode postar uma resposta.';
$hesklang['nsfo']='Nenhum artigo relevante encontrado.';
$hesklang['thist1']='<li class="smaller">%s | movida para a categoria %s por %s</li>'; // %s = date, new category, user making change
$hesklang['thist2']='<li class="smaller">%s | atribuída a %s por %s</li>'; // %s = date, assigned user, user making change
$hesklang['thist3']='<li class="smaller">%s | fechada por %s</li>'; // %s = date, user making change
$hesklang['thist4']='<li class="smaller">%s | aberta por %s</li>'; // %s = date, user making change
$hesklang['thist5']='<li class="smaller">%s | bloqueada por %s</li>'; // %s = date, user making change
$hesklang['thist6']='<li class="smaller">%s | desbloqueada por %s</li>'; // %s = date, user making change
$hesklang['thist7']='<li class="smaller">%s | solicitação criada por %s</li>'; // %s = date, user making change
$hesklang['elocked']='Esta solicitação foi bloqueada ou removida.';
$hesklang['nti2']='Inserir uma nova solicitação';
$hesklang['nti3']='Use este formulário para criar uma nova solicitação em nome do cliente. Digite as informações do <i>cliente</i> no formulário (nome do cliente, e-mail do cliente, ...) e NÃO seu nome! A solicitação será criada como se o cliente a tivesse enviado.';
$hesklang['addop']='Opções';
$hesklang['seno']='Enviar notificação por e-mail ao cliente';
$hesklang['otas']='Exibir a solicitação após o envio';
$hesklang['notn']='Notificações';
$hesklang['nomw']='A central de suporte enviará uma notificação por e-mail quando:';
$hesklang['nwts']='Uma nova solicitação for enviada com um responsável:';
$hesklang['ncrt']='O cliente responde a uma solicitação com um responsável:';
$hesklang['ntam']='Uma solicitação é atribuída a mim';
$hesklang['npms']='Uma mensagem privada é enviada para mim';
$hesklang['support_remove']='Muito tempo e esforço foram gastos no desenvolvimento do HESK. Ajude o HESK comprando uma licença que removerá os links de crédito <i>Powered by Sistema SAC Software HESK</i> de sua central de suporte';
$hesklang['ycvtao']='Você não possui permissão para ver solicitações atribuídas a outros';
...
$hesklang['seqid']='Número da solicitação';
$hesklang['close_action']='Marcar como resolvido'; // Close ACTION
$hesklang['archived']='Arquivado';
$hesklang['archived2']='Solicitação arquivada';
$hesklang['add_archive']='Arquivar esta solicitação';
$hesklang['add_archive_quick']='Arquivar solicitações selecionadas';
$hesklang['remove_archive']='Desarquivar esta solicitação';
$hesklang['remove_archive_quick']='Desarquivar solicitações selecionadas';
$hesklang['added_archive']='Solicitação arquivada';
$hesklang['removed_archive']='Solicitação desarquivada';
$hesklang['added2archive']='A solicitação foi arquivada';
$hesklang['removedfromarchive']='A solicitação foi desarquivada';
$hesklang['num_tickets_tag']='<b>%d</b> solicitações foram arquivadas';
$hesklang['num_tickets_untag']='<b>%d</b> solicitações foram desarquivadas';
$hesklang['can_add_archive']='Pode arquivar solicitações';
$hesklang['disp_only_archived']='Apenas solicitações arquivadas';
$hesklang['search_only_archived']='Apenas solicitações arquivadas';
...
$hesklang['thist10']='<li class="smaller">%s | atribuída automaticamente a %s</li>'; // %s = date, user making change
$hesklang['thist11']='<li class="smaller">%s | enviada pela fila por e-mail</li>'; // %s = date, user making change
// START abbreviations used in "last updated" column
...
$hesklang['yhbb']='Você foi bloqueado pelo sistema por %s minutos devido a muitas falhas ao tentar logar.';
...
$hesklang['eytid']='Digite seu código de identificação da solicitação.';
$hesklang['enmdb']='O endereço de e-mail que você digitou não corresponde ao existente em nosso banco de dados para a identificação desta solicitação.';
...
$hesklang['cot']='Não forçar solicitações críticas no topo';
$hesklang['def']='Defina esta minha visualização padrão';
$hesklang['gbou']='Estas solicitações estão <b>não atribuídas</b>:';
$hesklang['gbom']='Solicitações atribuídas a <b>mim</b>:';
$hesklang['gboo']='Solicitações atribuídas a <b>%s</b>:';
$hesklang['select']=' - - Clique para selecionar - - ';
$hesklang['chngstatus']='Alterar status para';
$hesklang['perat']='%s de todas as solicitações'; // Will change to "23% of all tickets"
...
$hesklang['tsst']='O status da solicitação foi definido como %s';
$hesklang['aass']='Atribuir automaticamente';
$hesklang['aaon']='Atribuição automática de solicitações habilitada (clique para desabilitar)';
$hesklang['aaoff']='Atribuição automática de solicitações desabilitada (clique para habilitar)';
...
$hesklang['taasy']='Esta solicitação foi atribuída automaticamente a você';
$hesklang['can_view_unassigned']='Pode ver solicitações não atribuídas';
$hesklang['ycovtay']='Você pode visualizar apenas solicitações atribuídas a você';
$hesklang['in_progress']='Em progresso';
$hesklang['on_hold']='Em espera';
$hesklang['import_kb']='Importar esta solicitação em um artigo da base de conhecimento';
$hesklang['import']='Você está importando uma <i>solicitação privada</i> em um <i>artigo público</i>.<br /><br />Certifique-se de remover qualquer informação privada ou sensível do assunto ou da mensagem do artigo!';
...
$hesklang['viewvtic']='Visualizar solicitações';
$hesklang['reqetv']='Exigir e-mail para visualizar uma solicitação';
$hesklang['banlim']='Limite de tentativas de login';
$hesklang['banmin']='Tempo de banimento (minutos)';
$hesklang['subnot']='Aviso de envio';
$hesklang['subnot2']='Exibir aviso aos clientes enviando solicitações';
$hesklang['eseqid']='Identificações sequenciais';
$hesklang['sconfe']='Confirmar e-mail';
$hesklang['saass']='Atribuir automaticamente solicitações';
...
$hesklang['emlpipe']='Fila por e-mail';
...
$hesklang['noopen']='Nenhuma solicitação aberta encontrada para este endereço de e-mail.';
$hesklang['maxopen']='Você atingiu o máximo de solicitações abertas (%d de %d). Por favor, aguarde até que suas solicitações existentes sejam resolvidas antes de abrir novas solicitações.';
$hesklang['ntnote']='Alguém adiciona uma observação a uma solicitação atribuída a mim';
$hesklang['cat_public']='Esta categoria é PÚBLICA (clique para tornar privada)';
$hesklang['cat_private']='Esta categoria é PRIVADA (clique para tornar pública)';
$hesklang['cat_aa']='Atribuir automaticamente solicitações nesta categoria.';
...
$hesklang['user_aa']='Atribuir automaticamente solicitações a este usuário.';
...
$hesklang['ool']='Listar apenas solicitações abertas no e-mail "Esqueceu seu código de identificação"';
$hesklang['mop']='Máximo de solicitações abertas';
...
$hesklang['can_merge_tickets']='Unificar solicitações';
$hesklang['mer_selected']='Unificar solicitações selecionadas';
$hesklang['merged']='As solicitações selecionadas foram unificadas em uma.';
$hesklang['merge_err']='Houve um problema ao unificar as solicitações:';
$hesklang['merr1']='selecione pelo menos duas solicitações.';
$hesklang['merr2']='solicitação alvo não encontrada.';
$hesklang['merr3']='solicitação em uma categoria que você não possui acesso.';
$hesklang['tme']='A solicitação %s foi unificada com esta solicitação (%s).';
$hesklang['tme1']='A solicitação %s foi unificada com a solicitação %s';
$hesklang['tme2']='Para acessar a solicitação %s digite o endereço de e-mail associado.';
$hesklang['eyou']='Use a página de perfil para editar suas configurações.';
...
$hesklang['thist']='Histórico da solicitação';
$hesklang['thist13']='<li class="smaller">%s | unido com solicitação %s por %s</li>'; // %s = date, merged ticket ID, user making change
...
$hesklang['twu']='O tempo dedicado à solicitação foi atualizado.';
$hesklang['autoss']='Iniciar automaticamente o contador quando eu abrir uma solicitação';
...
$hesklang['sconfe2']='Exibir um campo "Confirmar e-mail" no formulário de envio de solicitação';
...
$hesklang['fatte2']='Seu tamanho máximo de arquivo anexado é maior que o permitido pelo seu servidor!';
...
$hesklang['ddemo']='Desculpe, esta função está desabilitada no modo de DEMONSTRAÇÃO!';
...
$hesklang['wrepo']='Por favor, escreva uma resposta após reabrir a solicitação.';
$hesklang['ktool']='» Ferramentas da base de conhecimento';
...
$hesklang['can_export']='Pode exportar solicitações';
$hesklang['roo']='<i>(apenas solicitações atribuídas a você estão incluídas no relatório)</i>';
$hesklang['shu']='Links curtos';
$hesklang['export']='Exportar solicitações'; // Tab title
$hesklang['export_btn']='Exportar solicitações'; // Button title
$hesklang['export_intro']='Esta ferramenta permite a você exportar as solicitações em uma planilha XML que pode ser aberta no Excel.';
$hesklang['stte']='Selecionar solicitações para exportar';
...
$hesklang['ch2d']='» CLIQUE AQUI PARA BAIXAR O ARQUIVO DE EXPORTAÇÃO «';
$hesklang['n2ex']='Nenhuma solicitação encontrada correspondendo ao seu critério, nada a exportar!';
...
$hesklang['ticket_closed']='[#%%TRACK_ID%%] Solicitação fechada/resolvida';
$hesklang['ms01']='Jan';
$hesklang['ms02']='Fev';
$hesklang['ms03']='Mar';
$hesklang['ms04']='Abr';
...
$hesklang['ticket_tpl']='Modelos de solicitações';
$hesklang['can_man_ticket_tpl']='Gerenciar modelos de solicitações'; // Permission title
$hesklang['ticket_tpl_man']='Gerenciar modelos de solicitações'; // Page and link title
$hesklang['ticket_tpl_intro']='Crie e edite modelos de solicitações que você pode usar para rapidamente enviar novas solicitações da interface administrativa.';
$hesklang['no_ticket_tpl']='Nenhum modelo de solicitação';
$hesklang['ticket_tpl_title']='Título';
$hesklang['delete_tpl']='Você tem certeza de que deseja remover este modelo?';
$hesklang['new_ticket_tpl']='Adicionar ou editar um modelo de solicitação';
$hesklang['ticket_tpl_add']='Criar um novo modelo de solicitação';
$hesklang['ticket_tpl_edit']='Editar o modelo de solicitação selecionado';
$hesklang['save_ticket_tpl']='Salvar modelo de solicitação';
$hesklang['ticket_tpl_saved']='Seu modelo de solicitação foi salvo para uso futuro';
$hesklang['ticket_tpl_removed']='O modelo de solicitação selecionado foi removido do banco de dados';
$hesklang['ticket_tpl_not_found']='Modelo de solicitação não encontrado';
$hesklang['sel_ticket_tpl']='Selecione o modelo de solicitação que você deseja editar';
...
$hesklang['ticket_tpl_id']='Identificação do modelo de solicitação não encontrada';
$hesklang['select_ticket_tpl']='Selecionar um modelo de solicitação';
$hesklang['list_tickets_cat']='Listar todas as solicitações nesta categoria';
...
$hesklang['tab_7']='Lista de solicitações';
$hesklang['fitl']='Campos na lista de solicitações';
...
$hesklang['cat_pri']='A prioridade da categoria será usada quando os clientes não puderem selecionar a prioridade e uma solicitação for enviada pela interface do cliente.';
...
$hesklang['banemail_intro']='Impedir que certos endereços de e-mail enviem solicitações à sua central de suporte.';
...
$hesklang['email_banned']='O endereço de e-mail <i>%s</i> foi banido e o HESK não irá mais aceitar solicitações deste endereço.'; // %s will be replaced with email
...
$hesklang['baned_e']='Você foi proibido de enviar novas solicitações.';
...
$hesklang['banip_intro']='Visitantes dos endereços de IP banidos não poderão ver ou enviar solicitações e entrar na central de suporte.';
...
$hesklang['ip_banned']='O endereço IP <i>%s</i> foi banido e o HESK não aceitará mais solicitações deste endereço IP.'; // %s will be replaced with IP
$hesklang['ip_rbanned']='O intervalo IP <i>%s</i> foi banido e o HESK não aceitará mais solicitações deste intervalo IP.'; // %s will be replaced with IP
...
$hesklang['pncn']='Selecione a opção notificar cliente no formulário de nova solicitação';
$hesklang['pncr']='Selecione a opção notificar cliente no formulário de resposta à solicitação';
...
$hesklang['notnew']='Uma nova solicitação for enviada';
$hesklang['notclo']='Uma solicitação é marcada como Resolvida';
$hesklang['enn']='Exceto para solicitações de e-mails se o assunto do e-mail possuir:';
$hesklang['spamn']='Aviso de SPAM';
$hesklang['spam_inbox']='<span style="color:red"><b>Nenhum e-mail de confirmação?</b><br />Enviamos uma mensagem de confirmação para seu endereço de e-mail. Se você não a receber dentro de alguns minutos, por favor verifique suas pastas de Lixo Eletrônico, Lixeira ou Spam. Marque a mensagem como <b>Não é SPAM</b> para evitar problemas recebendo nossas correspondências no futuro.</span>';
...
$hesklang['kbo2']='<br /><br />Os visitantes não podem enviar novas solicitações e são encaminhados diretamente para a base de conhecimento.';
...
$hesklang['oon1']='Me envie apenas solicitações abertas';
$hesklang['oon2']='Me envie todas as minhas solicitações';
...
$hesklang['yhbr']='Você foi bloqueado do sistema por %s minutos devido a muitas respostas a uma solicitação.';
...
$hesklang['arpp']='Recarregar página automaticamente com a lista de solicitações a cada:';
$hesklang['seconds']='segundos';
$hesklang['minutes']='minutos';
$hesklang['atbr']='Esta solicitação precisa ser atribuída antes de poder ser respondida.';
$hesklang['attm']='Atribuir esta solicitação a mim';
$hesklang['owneed']='Responsável necessário';
$hesklang['taat']='Esta solicitação já está atribuída a <b>%s</b>.';
$hesklang['scoy']='Você tem certeza de que deseja atribuí-la a si mesmo?';
$hesklang['scot']='Você tem certeza de que deseja atribuí-la a %s?';
...
$hesklang['default_subject']='Solicitação de %s';
...
$hesklang['write_down']='<span style="color:red">Recomendamos que você anote o código de identificação de sua solicitação para futuras referências.</span>';
$hesklang['re_confirm1']='Desabilitar isto também desabilitará "Exigir e-mail para ver solicitações" em "Segurança". Prosseguir?';
...
$hesklang['et_intro']='Modificar e-mails que são enviados à sua equipe e clientes';
$hesklang['file']='Arquivo';
$hesklang['efile']='Editando arquivo';
$hesklang['rdesc']='(Destinatário) Descrição';
$hesklang['desc_forgot_ticket_id']='(Cliente) Esqueceu o código de identificação da solicitação';
$hesklang['desc_new_reply_by_staff']='(Cliente) Nova resposta da equipe';
$hesklang['desc_new_ticket']='(Cliente) Solicitação recebida';
$hesklang['desc_ticket_closed']='(Cliente) Solicitação fechada/resolvida';
$hesklang['desc_category_moved']='(Equipe) Solicitação movida para uma nova categoria';
$hesklang['desc_new_reply_by_customer']='(Equipe) Nova resposta do cliente';
$hesklang['desc_new_ticket_staff']='(Equipe) Nova solicitação enviada';
$hesklang['desc_ticket_assigned_to_you']='(Equipe) Uma solicitação foi atribuída a você';
$hesklang['desc_new_pm']='(Equipe) Nova mensagem privada';
$hesklang['desc_new_note']='(Equipe) Nova observação em uma solicitação atribuída a você';
...
$hesklang['ticket_url']='URL da solicitação';
$hesklang['pm_url']='URL da mensagem privada';
$hesklang['et_num']='Número de solicitações';
$hesklang['et_list']='Lista de solicitações';
$hesklang['et_empty']='O modelo de e-mail não pode ficar em branco';
...
$hesklang['select_category_staff']='Selecione a categoria da solicitação';
...
$hesklang['cf_intro']='Use este recurso para adicionar campos personalizados ao formulário Envie uma solicitação, assim você pode coletar dados adicionais dos clientes.';
...
$hesklang['can_resolve']='Pode resolver solicitações';
$hesklang['can_change_own_cat']='Pode alterar categoria da solicitação (para permitidas)';
$hesklang['can_submit_any_cat']='Pode enviar solicitações para qualquer categoria';
$hesklang['noauth_submit']='Você não está autorizado a enviar solicitações para esta categoria!';
$hesklang['noauth_move']='Você não está autorizado a mover solicitações para esta categoria!';
$hesklang['noauth_resolve']='Você não está autorizado a resolver solicitações!';
...
$hesklang['statuses_intro']='Use esta ferramenta para adicionar status de solicitação personalizados à sua central de suporte';
$hesklang['color']='Cor';
...
$hesklang['status_hesk']='Status padrões (não podem ser alterados aqui)';
...
$hesklang['list_tkt_status']='Listar todas as solicitações com este status';
...
$hesklang['status_not_empty']='Este status personalizado não pode ser removido pois existem solicitações com este status';
...
$hesklang['numsub']='Solicitações enviadas';
$hesklang['hidf']='Campos ocultos não são visíveis aos clientes no formulário Enviar uma solicitação (o valor ainda será visível na página de detalhes da solicitação se eles forem definidos como públicos). Eles funcionam como campos de texto comuns para membros da equipe.';
...
$hesklang['pop3_warning']='usuário %1$s tem o mesmo endereço de e-mail que o seu buscador POP3: %2$s'; // %1$s = username, %2$s = email address
$hesklang['fetch_warning']='Isso pode resultar em um loop de e-mail, onde novas solicitações são criadas pelas notificações de e-mail do usuário. Seu endereço de e-mail do buscador deve ser único e não deve ser usado por mais ninguém.';
$hesklang['can_view_ass_by']='Pode visualizar solicitações que ele/ela associou a outros';
$hesklang['can_privacy']='Pode anonimizar solicitações';
$hesklang['confirm_anony']='Anonimizar essa solicitação';
$hesklang['anon_selected']='Anonimizar solicitações selecionadas';
$hesklang['privacy_anon_info']='Remover todas as informações que podem identificar pessoalmente o remetente de solicitações (nome, e-mail, mensagem, anexos, IP...), mas conservar solicitações na base de dados para estatísticas (para serem esquecidas).';
$hesklang['success_anon']='Solicitação anonimizada com sucesso';
$hesklang['num_tickets_anon']='Número de solicitações anonimizadas: <b>%d</b>';
...
$hesklang['print_selected']='Imprimir as solicitações selecionadas';
...
$hesklang['assign_1']='As solicitações selecionadas foram alteradas para Desassociadas.';
$hesklang['assign_2']='Solicitação ID %1$s alterada para Desassociada'; // %1$s = ticket numerical ID
$hesklang['assign_3']='%1$s erro: já está associada para %2$s'; // %1$s = ticket tracking ID, %2$s = owner name
$hesklang['assign_4']='%1$s associada para %2$s'; // %1$s = ticket tracking ID, %2$s = owner name
$hesklang['assign_5']='%1$s erro: %2$s não tem acesso à categoria da solicitação'; // %1$s = ticket tracking ID, %2$s = owner name
$hesklang['assign_log']='Resultado de associação em massa de solicitações::<br /><br />Associado: %1$s<br />Erros: %2$s<br /><br />Log:<br /><pre>%3$s</pre>'; // %1$s = number of tickets assigned, %2$s = number of errors, %3$s = log
...
$hesklang['btn_lock']='Trancar solicitação';
$hesklang['btn_unlock']='Destrancar solicitação';
$hesklang['btn_tag']='Marcar solicitação';
$hesklang['btn_resend']='Reenviar notificação de e-mail';
$hesklang['btn_untag']='Desmarcar solicitação';
$hesklang['btn_import_kb']='Importar para a Base de Conhecimento';
$hesklang['btn_anony']='Anonimizar solicitação';
$hesklang['btn_delt']='Excluir solicitação';
$hesklang['btn_delr']='Excluir resposta';
$hesklang['ernf']='Resposta não encontrada';
$hesklang['tns']='Notificações da solicitação foram reenviadas';
$hesklang['rns']='Notificações de resposta foram reenviadas';
$hesklang['fname']='Primeiro nome';
$hesklang['export_selected']='Exportar solicitações selecionadas';
...
$hesklang['create_new_ticket']='Criar Nova Solicitação';
$hesklang['delete_article']='Deletar artigo';
$hesklang['view_existing_tickets']='Visualizar solicitações existentes';
$hesklang['how_can_we_help']='Olá, como podemos lhe ajudar?';
$hesklang['search_for_articles']='Pesquisar por artigos';
$hesklang['submit_a_support_request']='Nova Solicitação';
$hesklang['verify_header']='Prevenção de SPAM';
$hesklang['ticket_details']='Detalhes da Solicitação';
...
$hesklang['help_desk']='SAC'; // Displayed on staff sidebar menu
...
$hesklang['hide_replies']='Esconder respostas da solicitação';
...
$hesklang['lwidth']='Limitar largura da solicitação';
...
$hesklang['statistics']['intro']='Este relatório te dará informações sobre o uso do sistema de suporte e sobre a performance da equipe.';
$hesklang['statistics']['ntsp']='Não há solicitações no período selecionado.';
$hesklang['statistics']['pie_title_ro']='Solicitações Abertas X Resolvidas';
$hesklang['statistics']['open']='Aberto';
$hesklang['statistics']['resolved']='Resolvido';
$hesklang['statistics']['pie_title_as']='Solicitações abertas: Associadas X Não associadas';
$hesklang['statistics']['ass']='Associada';
$hesklang['statistics']['unas']='Não associada';
$hesklang['statistics']['pie_title_au']='Solicitações abertas: Respondidas vs. Sem resposta';
$hesklang['statistics']['answered']='Respondida';
$hesklang['statistics']['unanswered']='Sem resposta';
$hesklang['statistics']['pie_title_so']='Status das solicitações abertas';
$hesklang['statistics']['retic']='Solicitações:';
$hesklang['statistics']['chart_title_md']='Solicitações por dia do mês';
$hesklang['statistics']['chart_title_wd']='Solicitações por dia da semana';
$hesklang['statistics']['chart_title_hd']='Solicitações por hora do dia';
$hesklang['statistics']['chart_title_tfr']='Tempo até a primeira resposta da equipe';
$hesklang['statistics']['chart_title_tfrc']='Solicitações respondidas dentro de um intervalo de tempo';
$hesklang['statistics']['chart_title_ttr']='Tempo do envio à solução da solicitação';
$hesklang['statistics']['chart_title_ttrc']='Solicitações resolvidas dentro de um intervalo de tempo';
$hesklang['statistics']['chart_title_sr']='Respostas da equipe';
$hesklang['statistics']['chart_title_srt']='Respostas da equipe por solicitação';
$hesklang['statistics']['chart_title_srtr']='Respostas da equipe por solicitação (somente solicitações resolvidas)';
$hesklang['statistics']['chart_title_srt1']='Respostas da equipe por solicitação (solicitações com pelo menos 1 resposta)';
...
$hesklang['statistics']['axis1']='% de solicitações respondidas';
$hesklang['statistics']['axis2']='% de solicitações resolvidas';
$hesklang['statistics']['axis3']='% de solicitações';
$hesklang['statistics']['axis4']='Tempo para primeira resposta';
$hesklang['statistics']['axis5']='Tempo para resolvido';
$hesklang['statistics']['axis6']='Número de respostas';
$hesklang['statistics']['axis7']='Número de solicitações';
...
$hesklang['statistics']['attr']='Média de horas e minutos para resolver uma solicitação:';
$hesklang['statistics']['about']='aproximadamente %s'; // approximate time; "about 5 days 3 hours"
$hesklang['statistics']['na']='N/A';
$hesklang['statistics']['trept']='Total de solicitações respondidas pela equipe:';
$hesklang['statistics']['trnr']='Total de solicitações resolvidas sem uma resposta da equipe:';
$hesklang['statistics']['tsr']='Total de respostas da equipe:';
$hesklang['statistics']['tsrt']='Média de respostas da equipe por solicitação:';
$hesklang['statistics']['tsro']='Média de respostas da equipe por solicitação (solicitações com pelo menos 1 resposta da equipe):';
$hesklang['statistics']['tsrc']='Média de respostas da equipe requeridas para solução de uma solicitação:';
$hesklang['statistics']['tsrr']='Média de respostas da equipe requeridas para solução de uma solicitação (solicitações com pelo menos 1 resposta da equipe):';
...
$hesklang['overdue_ticket']='[#%%TRACK_ID%%] Solicitação vencida';
$hesklang['ticket_escalated']='[#%%TRACK_ID%%] ESCALADA: %%SUBJECT%%';
$hesklang['escalate']['tab']='Escalada'; // Menu link
$hesklang['escalate']['page_title']='Solicitações Escaladas'; // Page H2 title
$hesklang['escalate']['intro']='Este módulo o ajudará a escalar solicitações que não são atendidas a tempo.';
$hesklang['escalate']['feat1']='Solicitações não atribuídas, respondidas ou resolvidas dentro de um prazo';
$hesklang['escalate']['feat2']='Solicitações se aproximando da data de vencimento e solicitações vencidas';
$hesklang['escalate']['feat3']='Alterar automaticamente a prioridade da solicitação, reatribuir uma solicitação, enviar uma notificação por e-mail';
$hesklang['escalate']['feat4']='Aplicar regras com base na categoria da solicitação, proprietário, status';
...
$hesklang['escalate']['no_rules']='Você não tem regras de escalonamento. Crie uma clicando no botão "Nova regra de escalonamento" acima.';
$hesklang['escalate']['title']='Título da regra';
$hesklang['escalate']['titlet']='Um título descritivo, por exemplo: Reatribuir solicitações não respondidas em um dia';
...
$hesklang['escalate']['ifat']='Uma solicitação de suporte é:'; // If a ticket is not (resolved) within X (minutes) of submitting, then (resend notification)
$hesklang['escalate']['nrep']='não respondida pela equipe';
$hesklang['escalate']['nrepc']='não respondida pelo cliente';
$hesklang['escalate']['nass']='não atribuída';
$hesklang['escalate']['nres']='não resolvida';
$hesklang['escalate']['ndue']='se aproximando da data de vencimento';
$hesklang['escalate']['odue']='atrasada';
...
$hesklang['escalate']['ofs']='de ser submetida';
...
$hesklang['escalate']['assto']='Atribuir solicitação a:';
...
$hesklang['escalate']['tic']='Solicitações na categoria:';
$hesklang['escalate']['tat']='Solicitações atribuídas para:';
$hesklang['escalate']['tws']='Solicitações com status:';
$hesklang['escalate']['tall']='Aplique esta regra a solicitações existentes e futuras';
$hesklang['escalate']['tfn']='Aplique esta regra apenas a solicitações futuras, ignore as solicitações existentes';
$hesklang['escalate']['tfi']='Aplique esta regra apenas a solicitações com ID superior a:';
$hesklang['escalate']['save']='Salvar regra';
$hesklang['escalate']['e_tt']='O tempo deve estar entre 1 e 10000';
$hesklang['escalate']['e_a']='Selecione pelo menos uma ação para executar em solicitações correspondentes';
...
$hesklang['escalate']['edit_notice']='Alterar o gatilho da regra não terá efeito em nenhuma solicitação já escalada por esta regra (a menos que você redefina a regra).';
$hesklang['escalate']['reset']='Redefinir esta regra';
$hesklang['escalate']['reset2']='Tem certeza de que deseja redefinir esta regra?<br><br>Os êxitos da regra irão para 0 e qualquer solicitação que corresponda a essa regra será escalada novamente.';
...
$hesklang['escalate']['thist1']='<li class="smaller">%1$s | escalada por %2$s:</li>'; // Used in ticket history log. %1$s = date, %2$s = rule log title (above)
...
$hesklang['escalate']['thist6']='<li class="smaller">%1$s | - erro: %2$s não tem acesso à categoria de solicitações</li>'; // %1$s = date, %2$s = owner
$hesklang['escalate']['thist7']='<li class="smaller">%1$s | - erro: %2$s não tem permissão para ver as solicitações</li>'; // %1$s = date, %2$s = owner
$hesklang['escalate']['thist8']='<li class="smaller">%1$s | - erro: nenhum outro usuário que pode ver esta solicitação</li>'; // %1$s = date
$hesklang['escalate']['thist9']='<li class="smaller">%1$s | - aviso: prioridade já definida para %2$s</li>'; // %1$s = date, %2$s = priority
$hesklang['escalate']['thist10']='<li class="smaller">%1$s | - aviso: já atribuída a %2$s</li>'; // %1$s = date, %2$s = owner
...
$hesklang['escalate']['matched']='Número de solicitações correspondentes encontradas: %1$s '; // %1$s = number of tickets
...
$hesklang['escalate']['tbef']='Antes de uma regra ser ativada, você precisa ativá-la clicando na caixa de seleção na coluna "ATIVA".<br><br>
                               ...
                               isso afetará suas solicitações existentes antes de ativá-la.<br><br>
                               <strong>As regras ativas são processadas a cada %2$s minutos. Uma solicitação só pode ser escalada uma vez para cada regra</strong>.'; // %1$s = replaced by icon, %2$s = number of minutes, usually 5 or more
...
$hesklang['desc_ticket_escalated']='(Equipe) A solicitação foi escalada'; // Email description in admin panel
$hesklang['ticket_formatting_staff']='Formatação de Solicitações (Equipe)';
...
$hesklang['due_date_updated']='A data de vencimento da solicitação foi atualizada.';
...
$hesklang['ql_all']='Todas as Solicitações';
$hesklang['ql_alo']='Todas as solicitações abertas';
$hesklang['ql_fit']='Solicitações filtradas';
$hesklang['ql_a2m']='Atribuídas a mim';
$hesklang['ql_a2o']='Atribuídas a outros';
$hesklang['ql_una']='Não atribuídas';
$hesklang['ql_due']='Vencimento em breve';
$hesklang['ql_ovr']='Atrasada';
...
$hesklang['not_aos']='Algumas solicitações abertas às quais você tem acesso não são exibidas devido aos seus filtros.';
$hesklang['ntoverdue']='Uma solicitação está vencida com o proprietário:';
...
$hesklang['desc_overdue_ticket']='(Equipe) Solicitação em atraso';
$hesklang['overdue_starting']='Iniciando processo de notificação de solicitações vencidas';
$hesklang['overdue_sim']='O envio de e-mails e a atualização de solicitações estão desabilitados no modo SIMULAÇÃO.';
$hesklang['overdue_ticket_count']='Foram encontradas %s solicitações vencidas.'; // %s = Number of tickets
$hesklang['overdue_finished']='Solicitações Vencidas Concluídas. %s e-mails enviados. %s falhas ao enviar e-mails.'; // %s = Successful emails, failed emails
...
$hesklang['new_ticket_by_staff']='[#%%TRACK_ID%%] Solicitação recebida: %%SUBJECT%%';
...
$hesklang['aa_cat']='Atribuir solicitações automaticamente nesta categoria';
...
$hesklang['autoassign_off']='Não, enviar solicitações como não atribuídos';
$hesklang['autoassign_users']='Usuários a serem incluídos/excluídos na atribuição automática';
$hesklang['autoassign_selected_include']='Os usuários selecionados devem ser <strong>incluídos</strong> ao atribuir solicitações automaticamente nesta categoria';
$hesklang['autoassign_selected_exclude']='Os usuários selecionados devem ser <strong>excluídos</strong> ao atribuir solicitações automaticamente nesta categoria';
...
$hesklang['email_to_ticket']='Email para solicitação';
...
$hesklang['block_ignore']='E-mail para solicitação - Ignore e-mails e evite loops';
...
$hesklang['satisfaction']['after']='após a resolução da solicitação antes de enviar o email';
...
$hesklang['satisfaction']['tc']='Encontrados %s solicitações fechados que não tiveram a pesquisa de satisfação enviada.'; // %s = Number of tickets
$hesklang['satisfaction']['finished']='Pesquisa de satisfação do cliente finalizada. E-mails enviados: %1$s. Falha ao enviar e-mails: %2$s. Solicitações sem e-mail: %3$s. Solicitações com e-mail de desativação: %4$s.'; // %1$s = successful emails, %2$s = failed emails, %3$s = number of tickets without an email, %4$s = number of tickets with opt-out users
$hesklang['satisfaction']['oo']='Ignorando, este cliente não deseja receber e-mails de pesquisa.';
$hesklang['satisfaction']['ne']='Ignorando, esta solicitação está sem endereço de e-mail';
...
$hesklang['satisfaction']['feat3']='quando você resolver uma solicitação, o sistema enviará um e-mail ao seu cliente com o link para a pesquisa';
...
$hesklang['wrn_imap']='Você tem muitos emails não lidos em sua caixa de correio (%1$s). O Hesk transformará todos esses e-mails em solicitações.<br><br>Você pode marcar os e-mails existentes como lidos antes de ativar %2$s ou usar uma nova conta de e-mail para o Hesk.'; // %1$s = number of emails, %2$s = IMAP or POP3 fetching
$hesklang['wrn_pop3']='Você tem muitos e-mails em sua caixa de correio (%1$s). O Hesk transformará todos esses e-mails em solicitações.<br><br>Você pode excluir os e-mails existentes antes de ativar %2$s ou usar uma nova conta de e-mail para o Hesk.'; // %1$s = number of emails, %2$s = IMAP or POP3 fetching
...
$hesklang['desc_new_ticket_by_staff']='(Cliente) Nova solicitação enviado pela equipe';
...
$hesklang['previous_tickets']='Solicitações anteriores';
$hesklang['no_previous']='Sem solicitações anteriores para %s'; // %s = email address
$hesklang['all_previous']='Listar todos as solicitações anteriores';
$hesklang['confirm_delete_ticket']='Tem certeza de que deseja excluir permanentemente esta solicitação?';
$hesklang['confirm_delete_reply']='Tem certeza de que deseja excluir esta resposta permanentemente?';
$hesklang['select_new_category']='Número de solicitações nesta categoria: %s<br><br>Selecione uma nova categoria para transferir essas solicitações:'; // %s = Number of tickets
$hesklang['deleting_user_with_tickets']='Número de solicitações atribuídos a este usuário: %1$s<br>Número de solicitações <b>abertos</b> atribuídos a este usuário: %2$s solicitações<br><br><b>Aberto</b> será <b>não atribuído</b> após a exclusão deste usuário.'; // %1$s = total tickets, %2$s = open tickets
$hesklang['hlic']='Licença HESK';
$hesklang['hlic_free']='GRATIS';
$hesklang['hlic_buyl']='Compre uma licensa';
$hesklang['hlic_paid']='Licenciado';
$hesklang['antdemo']='O envio de solicitações do painel de administração foi desativado no modo de demonstração.<br><br>Use o <a href="%s" target="_blank">lado público</a> para enviar uma solicitação de teste.';
...
$hesklang['email_oauth_providers_intro']='Use esta ferramenta para adicionar provedores OAuth ao seu Sistema SAC';
...
$hesklang['email_oauth_provider_cannot_be_deleted']='Este provedor não pode ser removido porque está sendo usado pelo Sistema SAC.';
...
$hesklang['customer_reset_password']='Redefinir sua Senha do Sistema SAC';
...
$hesklang['customer_accounts_required']='<strong>Habilitado - Necessário para acessar</strong> (somente clientes logados podem acessar o Sistema SAC e a base de conhecimento)';
...
$hesklang['no_customers_enabled2']='Alternativamente, os botões acima desta mensagem permitem que você crie manualmente contas de clientes ou importe clientes existentes para o Sistema SAC.';
...
$hesklang['deleting_customer_delete_tickets']='Excluir tickets';
$hesklang['deleting_customer_anonymize_tickets']='Tornar os tickets anônimos';
$hesklang['deleting_customer_retain_tickets']='Reter bilhetes';
...
$hesklang['loc_home']='Página inicial do Sistema SAC';
